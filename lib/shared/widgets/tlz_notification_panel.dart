...
String? _resolveNotificationRoute(AppNotification notification) {
  ...
  return switch (notification.category) {
    ...
    'venue_supply' => '/community/sports/courts',
    'venue_booking' => '/community/sports/courts',
    'coach_supply' => '/community/sports/coaches',
    'coach_booking' => '/community/sports/coaches',
    'system' => '/profile',
...
class _TlzNotificationPanelState extends ConsumerState<TlzNotificationPanel> {
  static const _filters = <({String label, String? value})>[
    ...
    (label: 'ลงทะเบียนสนาม', value: 'venue_supply'),
    (label: 'จองสนาม', value: 'venue_booking'),
    (label: 'ลงทะเบียนโค้ช', value: 'coach_supply'),
    (label: 'นัดโค้ช', value: 'coach_booking'),
