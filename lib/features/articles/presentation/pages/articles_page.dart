...
class _ArticlesPageState extends State<ArticlesPage> {
  ...
  Future<void> _loadInitialArticles() async {
    ...
    try {
      ...
      final articles = await ServiceLocator.instance.healthArticleRepository
          .getAllArticles(
      ...
      try {
        ...
        if (mounted) {
          ...
          if (errorMsg.contains('403')) {
            errorMsg =
                'สิทธิ์ถูกปฏิเสธ (403): ตรวจสอบว่าล็อกอินหรือยัง หรือตรวจสอบ Storage Policy';
                    ...
                    Row(
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () =>
                              setDialogState(() => blocks.removeAt(index)),
                        ),
                      ],
                    ),
                    TextField(
                          ...
                          SizedBox(
                            ...
                            child: SliderTheme(
                              ...
                              child: Slider(
                                ...
                                onChanged: (val) =>
                                    setDialogState(() => block.height = val),
                              ),
                            ),
                          ),
                        ],
                        ...
                        child: Row(
                          children: [
                            _ToolbarButton(
                              ...
                              tooltip: 'ตัวหนา',
                              onPressed: () {
                                final focused = blocks.firstWhere(
                                  (b) => b.focusNode?.hasFocus ?? false,
                                  orElse: () => blocks.first,
                                );
                                formatText(focused, '**', '**');
                              },
                              ...
                              onPressed: () {
                                if (blocks
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    const SnackBar(
                                      content: Text(
                                        'คุณเพิ่มรูปภาพครบจำนวนที่กำหนดแล้ว',
                                      ),
                                    ),
                                  );
                                  return;
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      const SizedBox(width: 8),
                                      const Text(
                                        'แท็กยาเพื่อเชื่อมโยงสินค้าเข้าสู่บทความของคุณ',
                                        style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 13,
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          _showAddTagDialog(context, (tag) {
                                            if (!productLinks.contains(tag)) {
                                              setDialogState(
                                                () => productLinks.add(tag),
                                              );
                                            }
                                          });
                                        },
                            ...
                            child: ElevatedButton(
                              onPressed: isSaving
                                  ...
                                  : () async {
                                      ...
                                      try {
                                        final repository = ServiceLocator
                                            .instance
                                        ...
                                        final newArticle = await repository
                                            .createArticle(
                                              userId: currentUser.id,
                                              title: titleController.text
                                                  .trim(),
                                              content:
                                                  contentJson, // Save as JSON
                                              imageUrl: firstImage.isNotEmpty
                                                  ? firstImage
                                                  : null,
  ...
  void _showAddTagDialog(BuildContext context, Function(String) onAdd) {
    String searchQuery = '';
          ...
          children: [
            ...
            Expanded(
              ...
              child: Stack(
                ...
                children: [
                  Container(
                    decoration: BoxDecoration(color: _blue.withOpacity(0.05)),
