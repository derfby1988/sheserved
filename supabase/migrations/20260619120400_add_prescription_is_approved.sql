-- Fix: prescriptions table missing is_approved column
-- This causes get_expert_completion_status and can_expert_finish_job to fail

-- 1. Add missing column
ALTER TABLE public.prescriptions
ADD COLUMN IF NOT EXISTS is_approved BOOLEAN DEFAULT false;

-- 2. Recreate get_expert_completion_status with all fixes
...
-- 3. Recreate can_expert_finish_job with all fixes
...
BEGIN
  ...
  -- เช็คคำถามบังคับ (ใช้ room_id แทน consultation_id ใน chat_messages)
