        ...
        ffmpeg(filePath)
            ...
            .on('end', async () => {
                ...
                try {
                    ...
                    const isLocalUrl = finalUrl.includes('localhost') || finalUrl.includes('192.168.0.112') || !process.env.BUNNY_CDN_URL || process.env.BUNNY_CDN_URL === 'https://your-pull-zone.b-cdn.net';
