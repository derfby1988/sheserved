...
- **Database Recording**: เมื่อผู้ใช้กดปิดการ์ด (ไม่ว่าจะกด X หรือปัดซ้าย) ระบบจะบันทึก ID ของวิดีโอนั้นลงในตาราง `user_ui_preferences` ภายใต้คีย์ `dismissed_emergency_alert_ids`
- **Avoid Duplication**: ระบบจะกรองรายการที่ถูกยกเลิกไปแล้วออกจากการแสดงผลทุกครั้ง (ทั้งตอนโหลดแอปและแบบ Real-time) เพื่อไม่ให้แสดงซ้ำจนเกิดความรำคาญ
