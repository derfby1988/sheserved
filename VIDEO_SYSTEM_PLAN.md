...
- ทุกการแจ้งเตือนในหน้า Home จะต้องผ่านการตรวจสอบความสัมพันธ์ (Relevance Check) ระหว่าง `categoryId` และ `professionId` ในตาราง `incident_categories` เท่านั้น หากไม่มีการจับคู่กัน ระบบจะถือว่าไม่เกี่ยวข้องและไม่แสดงผลการแจ้งเตือน (ยกเว้นโหมดไทยมุงที่มีเงื่อนไขเฉพาะ)
